...
| **4 Forces** | **Push:** 수작업 취합 스트레스
**Pull:** 자동 수집·요약에 대한 기대
**Habit:** 익숙한 스프레드시트 중심 업무 패턴
**Anxiety:** 새 툴 도입 시 권한/보안 이슈 |
| **Current Solutions** | **Google Sheet + 수동 CSV 업로드 + Slack 요청** |
| **Switch Triggers / Barriers** | **Trigger:** CFO의 “오탈자 지적” 이후 자동화 도구 탐색 시작
**Barrier:** 보안·권한 관리 이슈로 도입 보류 |
| **Evidence (근거)** | “전표가 늦게 들어와 엑셀을 다시 합쳐요.”
지난 3개월 평균 취합시간 **5.6시간** |
| **Priority (AOS / DOS)** | **AOS = 3.0**, **DOS = 2.4** (Importance=5, Satisfaction=2, TAM=0.8) |
| **Notes (추가 메모)** | **MVP:** 3소스 연결, 자동 요약, PDF 내보내기 기능 중심SSO 통합 필수 |
